...
int fonk(int x)
{
    ...
    onu çağirmaya gidiyo bu boyle x=0 olana kadar devamm ediyor. x=0 olunca retrun 0 donduruyo ama kodun devamini okumamisti. f(1)i çagirmisti ya eb son ordan baliyo
